  ...
  return (
    <form className="space-y-4">
      ...
      <div className="mt-6 pb-3">
            ...
            <select className="w-full border-2 rounded-lg p-4 bg-white text-black placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500">
      ...
      <div className="flex items-center pb-5">
        ...
        <label className="text-sm text-gray-500">I accept the <span className="text-orange-500 hover:underline">Terms of Use & Privacy Policy</span></label>
      </div>

      {/* Submit Button */}
      <button className="w-full py-4 bg-orange-500 text-white rounded-xl font-semibold text-base hover:bg-orange-600 transition-all duration-200">
        Register Now
      </button>
    </form>
  );
