 ...
 const Hero = () => {
  return (
   <div className="flex flex-col items-center mt-6 lg:mt-20">
    ...
    Join a Community of 
    <span className="bg-gradient-to-r from-orange-500 to-red-800 text-transparent bg-clip-text"> Learners </span>
    Like You!
    </h1>
...
new skills—all while having fun.
    ...
    <span className="mt-10 text-xl bg-gradient-to-r from-orange-500 to-red-800 text-transparent bg-clip-text">
